...
#         self.mlp = self._make_mlp(hidden_dims=inr_latent, act=nn.GELU(), 
#                                   in_dim=enc_dim, out_dim=latent_dim)
#         self.act = LayerNorm(latent_dim)
...
#         self.norms = nn.ModuleList([LayerNorm(out_dim) for _ in k_list])
